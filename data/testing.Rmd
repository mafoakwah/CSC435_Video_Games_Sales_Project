...
author: "Matthew Afoakwah, Nathan Cummings, Jaye Evans, Kevin Mainello, Chris Weiner, " 
output:
...
gamesales2010_2016$Platform <- recode(gamesales2010_2016$Platform, "X360" = "Xbox", "PS3" = "Playstation",
                                      "DS" = "Nintendo", "PS4" = "Playstation", "3DS" = "Nintendo", "Wii" = "Nintendo", "XOne" = "Xbox", "WiiU" = "Nintendo", "PSP" = "Playstation", "PSV" = "Playstation", "PS2" = "Playstation")
```
...
We create another table which calculates the NA and Global sales for each platform for everty different year as well.
```{r}
#We move the gamesales2010_2016 data into a new data set.
...
ggplot(platform_glbl_sales , aes(x = Platform, y = glbl_total)) + geom_point(stat = "identity") + geom_segment(aes( x = Platform, xend = Platform, y = 0, yend = glbl_total )) + labs(title = "Global Sales by Platform", x = "Platform", y = "Global Sales\n(in millions)")
