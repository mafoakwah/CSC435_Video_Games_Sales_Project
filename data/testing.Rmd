...
#We use uinque()to list the unique attributes in the platform column.
unique(gamesales2010_2016$Platform)
```
...
Analysis:
Overall, from these graphs we can see that Xbox is the most profitable between all these platforms. However, compared to 2010 when it was at its highest, we are able to see that the sales for Xbox has been steadily declining same goes for they other platforms as well. But, compared to other platforms it is evident that the PlayStation and XOne has both increased in terms of sales since 2010.
